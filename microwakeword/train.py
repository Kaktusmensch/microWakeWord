...
def validate_nonstreaming(config, data_processor, model, test_set):
    ...
    test_set_fp = (((((((((((((((((((((((((((((result["fp"].numpy() if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"]) if hasattr(result["fp"], "numpy") else result["fp"])
    ...
    if data_processor.get_mode_size("validation_ambient") > 0:
        ...
        duration_of_ambient_set = (
            len(ambient_testing_ground_truth) * (int(1000 * (config["window_step_ms"] / 1000.0) * config.get("stride", 1)) * (config["window_step_ms"] / 1000.0)) / 3600.0
        )
        if duration_of_ambient_set == 0:
            duration_of_ambient_set = 1.0 / 3600.0

        # Other than the false positive rate, all other metrics are accumulated across
        # both test sets
        all_true_positives = (((((((((((((((((((((((((((((ambient_predictions["tp"].numpy() if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"]) if hasattr(ambient_predictions["tp"], "numpy") else ambient_predictions["tp"])
        ambient_false_positives = (((((((((((((((((((((((((((((ambient_predictions["fp"].numpy() if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) if hasattr(ambient_predictions["fp"], "numpy") else ambient_predictions["fp"]) - test_set_fp
        all_false_negatives = (((((((((((((((((((((((((((((ambient_predictions["fn"].numpy() if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"]) if hasattr(ambient_predictions["fn"], "numpy") else ambient_predictions["fn"])
